...
TRAIN_DIR = "/home/hawkeyenew3/zjw/dataset/nyud_cropped/"
VAL_DIR = TRAIN_DIR
#TRAIN_LIST = ["./data/train.nyu"] * 3
#VAL_LIST = ["./data/val.nyu"] * 3
TRAIN_LIST = ["/home/hawkeyenew3/zjw/code/refinenet/data/train.nyu"] * 3
VAL_LIST = ["/home/hawkeyenew3/zjw/code/refinenet/data/val.nyu"] * 3
SHORTER_SIDE = [350] * 3
CROP_SIZE = [500] * 3
NORMALISE_PARAMS = [
    1.0 / 255,  # SCALE
